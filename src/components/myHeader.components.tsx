...
export default function MyHeader() {
  ...
  return (
    <div className="flex w-full justify-between bg-[#87cacc] py-2 px-5">
      ...
      {isAuthenticated ? (
        <div className="space-x-4 py-1 flex text-center flex-row font-black text-black text-[15px] capitalize items-center">
          {/* Home */}
          <Link href="/">
            <div className="flex items-center space-x-1 text-black hover:text-white py-2 px-2 rounded-md hover:bg-green-600 transition duration-200">
              <svg
          ...
          <button
            onClick={logout}
            disabled={loading}
            className={`flex items-center text-black hover:text-white py-2 px-2 rounded-md hover:bg-red-700 transition duration-200 ${
