                ...
                <div key={index} className="bg-gray-50 rounded-md shadow-lg overflow-hidden flex flex-col relative">
                    <div className="relative">
                        ...
                        <button
                            ...
                            className={`absolute p-2 top-2 right-2 bg-transparent border-none cursor-pointer z-10 transition duration-300 ${favorites.includes(article.id) ? 'text-yellow-500' : 'text-gray-500'
                                }`}
                        >
