...
const ArticlesGrid: React.FC<ArticlesGridProps> = ({ articles, setSelectedArticle, addToFavorites }) => {
    ...
    return (
        <div className="w-full py-2 mt-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {articles.map((article, index) => {
                ...
                return (
                    <div key={index} className="bg-gray-50 rounded-md shadow-lg overflow-hidden flex flex-col relative">
                        ...
                        <div className="flex justify-between items-center px-3 py-2 bg-gray-200">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 1-2.25 2.25M3.75 7.5h7.5" />
                                </svg>
                            </button>
                        </div>
                    </div>
